...
export const BOARD_TILES: readonly BoardTile[] = [
  ...
  { id: 5, type: 'airport', name: 'مطار دمشق الدولي' },
  ...
  { id: 12, type: 'utility', name: 'شركة الكهرباء' },
  ...
  { id: 15, type: 'airport', name: 'مطار الرياض الدولي' },
  ...
  { id: 25, type: 'airport', name: 'مطار القاهرة الدولي' },
  ...
  { id: 28, type: 'utility', name: 'شركة المياه' },
  ...
  { id: 35, type: 'airport', name: 'مطار دبي الدولي' },
